...
@Setter
@Entity
public class CookBooking {

    @Id
    private String cookBookingId;
    ...
    @Pattern(regexp = "^(1 month|3 months|6 months|1 year)$", message = "Duration must be one of the following: 1 month, 3 months, 6 months, 1 year")
